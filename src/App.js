  ...
  return (
    <div className="body">
      <div className="header" style={{ backgroundColor: bg }}>
        <span className={cursor ? 'custom-cursor' : ''} onClick={handleClick} style={{ cursor: cursor ? 'url("https://raw.githubusercontent.com/jordan-trempert/media/main/stardom_cursor.png"), auto' : 'auto' }}>
          <img
